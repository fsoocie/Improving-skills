        ...
        <Col span={24}>
          <div className='skillsHeader' style={{paddingBottom: 0, paddingTop: 6}}>
            ...
            <Row style={{paddingTop: 10}}>
              <Col span={3}><Avatar size={64} icon={<UserOutlined />} /></Col>
              <Col className='skillsDetailContent' span={17}>
                <Title className='skillsDetailContent__name' level={3}>Programming</Title>
                <Text className='skillsDetailContent__status'>Novice</Text>
                <Text className='skillsDetailContent__hours' >44 hours</Text>
              </Col>
              <Col className='skillsDetailLevel' span={4}>
                <Title className='skillsDetailLevel__number' level={2} >19</Title>
                <Text className='skillsDetailLevel__text'>Level</Text>
              </Col>
              <Col span={24} >
                <Progress showInfo={false} percent={39} />
              </Col>
            </Row>
            <Row className='tabs'>
              <Col span={12}>
